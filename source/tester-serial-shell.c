	...
	while(*buf)
 	{
		...
		if(argc > 0)
		{
			...
			if(cmd == 0)
			{
				console_print(2, " Could not found \"");
				console_print(2, argv[0]);
				console_print(2, "\" command\r\n");
				console_print(2, " If you want to konw available commands, type 'help'\r\n");
		   	}
			else
			{
				cmd->func(argc,argv);
...
void help(int argc, char ** argv)
{
	...
	case 1:
		for(i = 0; i < ARRAY_SIZE(command_lit); i++)
		{
			console_print(2, command_lit[i].help);
			console_print(2, "\r\n");
		}
		break;
	default:
		console_print(2, " Invalid 'help' command: too many arguments\r\n");
		console_print(2, " Usage:\r\n");
		console_print(2, "     help\r\n");
		break;
	}
}
...
void clear(int argc, char ** argv)
{
	...
	{
	case 1:
		console_print(2, "\033[2J");
		cx = 0;
		cy = 0;
		break;

	default:
		console_print(2, " Invalid 'clear' command: too many arguments\r\n");
		console_print(2, " Usage:\r\n");
		console_print(2, "     clear\r\n");
		break;
	}
}
...
void reboot(int argc, char ** argv)
{
	...
	default:
		console_print(2, " Invalid 'reboot' command: too many arguments\r\n");
		console_print(2, " Usage:\r\n");
		console_print(2, "     reboot\r\n");
		break;
	}
}
...
int tester_serial_shell(int argc, char * argv[])
{
	...
	console_print(2, "\033[2J");
	console_print(2, "s5pv210 shell test...\r\n");
